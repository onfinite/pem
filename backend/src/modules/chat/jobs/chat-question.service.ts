...
import { formatChatRecallStamp } from '@/modules/chat/utils/format-chat-recall-stamp';
import {
...
import {
  ExtractsService,
  type BriefBuckets,
} from '@/modules/extracts/extracts.service';
import { visionLineForHumans } from '@/modules/chat/utils/photo-vision-stored';
...
import { buildSavedLinksRecallPromptSection } from '@/modules/chat/jobs/saved-links-recall-for-ask';
import {
...
import {
  ...
  generateAskAnswerText,
} from '@/modules/chat/agents/chat-question-answer-llm';
...
export class ChatQuestionService {
  ...
  async answer(
    ...
    try {
      ...
      const text = await generateAskAnswerText({
        apiKey,
        system: buildAskQuestionSystemPrompt(nameNote),
