...
} from '@/modules/chat/jobs/resolve-photo-recall-message-ids';
import { shouldSkipPhotoRecallStrip } from '@/modules/chat/jobs/photo-recall-strip-guard';
import { logWithContext } from '@/core/utils/format-log-context';
import {
  classifyPhotoRecallIntentWithLlm,
  type PhotoRecallIntentOutput,
} from '@/modules/chat/agents/chat-photo-recall-intent-llm';
...
export class ChatPhotoRecallIntentService {
  ...
  private async runClassifier(
    ...
    return classifyPhotoRecallIntentWithLlm({
      apiKey,
      modelId,
      userText,
