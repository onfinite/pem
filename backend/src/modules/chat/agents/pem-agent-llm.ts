...
} from '@/modules/chat/prompts/pem-agent.system-prompt';
import {
  extractionIsEmpty,
  messageLikelyContainsTasks,
  shortAffirmationToPlanRecentPhoto,
  truncateForPrompt,
} from '@/modules/chat/utils/pem-agent-message';
...
@Injectable()
export class PemAgentLlm {
  private readonly log = new Logger(PemAgentLlm.name);
